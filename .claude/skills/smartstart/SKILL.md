---
name: smartstart
description: Use this to write code to call an LLM using LiteLLM and OpenRouter with the smartstart provider
---

# Calling an LLM via smartstart

These instructions allow you write code to call an LLM with smartstart specified as the inference provider.  
...
Use code like these examples in order to use smartstart.
...
### Code to call via smartstart for a text response
...
### Code to call via smartstart for a Structured Outputs response
